          ...
          layer.open({
            ...
            ,success: function(layero, index){
            	...
            	$(document).on("change","#layui-upload-file",function(){
            		var image =  document.getElementById("layui-upload-file").files[0];
            			...
            			//准备表单
            				...
            				if(ret==null){
            					layer.msg("图片上传失败");
            					 ...
            					 layui.focusInsert(editor[0], 'img['+ basePath+ret + '] ');		//basePath没有定义？？可以用
            					 layer.close(index);	
            				}
            				}
            				//发生错误
            				...
            				//发起ajax请求
            				xhr.open("POST",basePath+'fileUploadController/upload/',false);
            				xhr.send(fd);  
            		  }
            			
            	});
//              layui.upload({
//                url: bathPath+'fileUploadController/upload/'
